...
func main() {
	...
	puzzle := flag.String("puzzle", cfg.Puzzle, "81-cell Sudoku puzzle; blanks may be 0, ., or _; whitespace and |/+ separators are ignored")
	puzzleName := flag.String("name", cfg.Name, "puzzle name used in the generated report")
	flag.Parse()
