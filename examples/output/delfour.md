...
## Check  
C1 OK - signature verifies  
C2 OK - payload hash matches  
C3 OK - minimization strips sensitive terms  
C4 OK - scope complete  
C5 OK - authorization allowed  
C6 OK - high-sugar banner  
C7 OK - alternative lowers sugar  
C8 OK - duty timing consistent  
C9 OK - marketing prohibited  
