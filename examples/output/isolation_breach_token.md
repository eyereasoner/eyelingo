...
C2 OK - each medium has distinguishable safe/breach states  
C3 OK - prepare-task count is independently recomputed from all states  
C4 OK - the expected prepared breach state belongs to nursePager  
C5 OK - the expected serial audit path is backed by legal directed edges  
