...
C2 OK - the tuned complex has delocalized states  
C3 OK - the tuned complex has a tuned vibronic bridge  
C4 OK - the tuned complex has moderate dephasing and short-lived coherence  
C5 OK - the tuned complex is connected downhill to the reaction center  
C6 OK - efficient transfer is independently derived for the tuned complex  
